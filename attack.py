...
if args.externaldata!='':
    if args.datatype == 'char':
        ...
        test_loader = DataLoader(testchar,batch_size=args.batchsize, num_workers=2, shuffle=False)
        ...
        test_loader = DataLoader(testword,batch_size=args.batchsize, num_workers=2,shuffle=False)
else:
    if args.datatype == "char":
        ...
        test_loader = DataLoader(testchar,batch_size=args.batchsize, num_workers=2, shuffle=True)
        alphabet = trainchar.alphabet
        ...
        test_loader = DataLoader(testword,batch_size=args.batchsize, num_workers=2,shuffle=True)
